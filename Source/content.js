...
function ApplyDarkModeToElement(Element) {
  ...
  for (const StyleProperty of DarkModeConfig.StyleProperties) {
    ...
    if (StyleProperty === "background" && PropertyValue.includes("gradient")) {
  ...
  if (GradientDetected) {
    ...
    Element.style.setProperty("background", DarkModeConfig.DarkBackgroundColor, "important");
  }
